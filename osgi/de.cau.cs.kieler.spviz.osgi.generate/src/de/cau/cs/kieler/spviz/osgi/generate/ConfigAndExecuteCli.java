...
/**
 * This class is a command line tool that executes the generation of the OSGi
 * model files. The project parameters for this generation are configured via
        ...
        if (projectPaths != null) {
            ...
            for (final Entry<String, File> projectPathEntry : projectPaths.entrySet()) {
                LOGGER.log(System.Logger.Level.INFO,
                    "Reading Project Data for " + projectNames.get(projectPathEntry.getKey()));
                final String projectKey = projectPathEntry.getKey();
            ...
            LOGGER.log(System.Logger.Level.INFO,
                "OSGi model generation has finished. The files can be found in " + modelSaveFilePath);
        }
    }
